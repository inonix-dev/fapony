 ...
 * Returns one entry per platform, ordered: claude, opencode, zcode, codex.
 *
 * Uses resolvers from each provider (file-exists check) for opencode/zcode/codex,
 * and `command -v claude` for claude — all through injected deps for testability.
 */
